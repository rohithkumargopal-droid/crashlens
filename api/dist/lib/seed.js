...
const challenges = [
    {
        ...
        difficulty: "easy",
        description: "The Payment API is returning 502s. Something is wrong between the API and its database.",
        root_cause: "Postgres has run out of available connections — too many idle connections from a leaky pool are holding slots open.",
...
async function main() {
    for (const c of challenges) {
        await pool.query(`INSERT INTO challenges (slug, title, difficulty, description, root_cause, fix_action_key, hint_ladder, fix_options)
